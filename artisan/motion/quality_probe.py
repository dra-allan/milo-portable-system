...
Always exits 0 â€” the caller treats probe failures as "unknown" and starts the
...
# dotenv (openshorts app convenience) not vendored; env comes from the daemon.
...
def main() -> int:
    ...
    try:
        ...
        # serve HD without PO tokens â€” never override them here.
        attempts = []
        if cookies_path:
