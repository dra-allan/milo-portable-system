...
class RankingConfig:
    def __init__(self):
        ...
        self.oauth_client_secrets=os.getenv('RANKING_OAUTH_CLIENT_SECRETS',str(PROJECT_ROOT/'credentials.json')); self.oauth_token_file=os.getenv('RANKING_OAUTH_TOKEN_FILE',str(self.runtime_root/'config'/'youtube_token_ranking.json')); self.privacy_status=os.getenv('UPLOAD_PRIVACY','private').lower(); self.upload_max_per_run=_i('UPLOAD_MAX_PER_RUN',1); self.dry_run=_b('DRY_RUN',False)
