# register_interactive_tasks.ps1
$ActionMB = New-ScheduledTaskAction -Execute "cmd.exe" -Argument '/c start "" "C:\milo-portable-system\scripts\launchers\launch_morning_brief.bat"' -WorkingDirectory "C:\milo-portable-system\scripts\launchers"
...
$ActionYT = New-ScheduledTaskAction -Execute "cmd.exe" -Argument '/c start "" "C:\milo-portable-system\scripts\launchers\launch_youtube_shorts.bat"' -WorkingDirectory "C:\milo-portable-system\scripts\launchers"
...
# 3. Ranking Shorts Pipeline
$ActionRS = New-ScheduledTaskAction -Execute "cmd.exe" -Argument '/c start "" "C:\milo-portable-system\scripts\launchers\launch_ranking_shorts.bat"' -WorkingDirectory "C:\milo-portable-system\scripts\launchers"
...
Write-Host "All interactive physical tasks registered successfully!"
