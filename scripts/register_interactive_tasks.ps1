...
$ActionMB = New-ScheduledTaskAction -Execute "cmd.exe" -Argument '/c start "" "C:\milo-portable-system\scripts\scheduled\scheduled_morning_brief.bat"' -WorkingDirectory "C:\milo-portable-system\scripts\scheduled"
...
$ActionYT = New-ScheduledTaskAction -Execute "cmd.exe" -Argument '/c start "" "C:\milo-portable-system\scripts\scheduled\scheduled_youtube_shorts.bat"' -WorkingDirectory "C:\milo-portable-system\scripts\scheduled"
...
$ActionRS = New-ScheduledTaskAction -Execute "cmd.exe" -Argument '/c start "" "C:\milo-portable-system\scripts\scheduled\scheduled_ranking_shorts.bat"' -WorkingDirectory "C:\milo-portable-system\scripts\scheduled"
